...
const IncorrectIncomeCreation = () => {
    ...
    const handleClick = async e =>{
        e.preventDefault()
        try{
            await axios.post("http://localhost:8800/incorrectincomecreation",income)
            navigate("/income")
        }catch (err) {
            console.log(err)
        }
    ...
    <div className = 'incomeForm'>
        <h1>Please specify all fields.</h1>
        <h1>Source</h1>
...
export default IncorrectIncomeCreation